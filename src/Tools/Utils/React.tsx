...
type classIfType = OBJ<boolean | undefined>;
export const classNames = (...entries: (string | classIfType | undefined)[]) => {
	let classes = '';
	entries.forEach(e => {
		if (!e) return;
...
export const classes = (...entries: (string | classIfType | undefined)[]) => ({ className: classNames(...(entries || [])) });
